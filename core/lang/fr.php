...
return [
    ...
    'gallery' => [
        'title' => 'Galerie',
        'description' => 'Retrouvez ici l\'historique des mes dessins.',
        'new_badge' => 'Nouveau'
    ],
    'faq' => [
        'title' => 'FAQ',
        ...
        'refund_question' => 'Acceptes-tu les remboursements ?',
        'refund_answer' => 'Si je n\'ai pas encore commencé, ou si je n\'ai fait qu\'un croquis, c\'est possible, autrement je suis désolé mais un remboursement est impossible.',
        'time_question' => 'Combien de temps une commission prend-elle ?',
    ...
    'footer' => [
        ...
        'copyright' => '© 2025 Xano - Tous droits réservés'
    ]
];